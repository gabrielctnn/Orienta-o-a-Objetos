...
## 📌 Sobre o Projeto
Este projeto simula um sistema de cadastro de pessoas (`Person`), explorando como proteger dados de uma classe e como os objetos interagem entre si de forma segura.

---

## 🏗️ Conceitos Aplicados (Resumo)

* **Abstração:** Uso da classe `Person` como molde para instanciar múltiplos objetos (`homem`, `mulher`) com estados independentes.
...
- `Main.java`: Classe principal para execução e teste do fluxo.
